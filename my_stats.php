...
<div id="StatUsername" align="center" onClick="ViewUser(<?php echo $userp['id'] ?>)"><?php echo $userp['username'] ?>'s Stats</div>
...
<table width="600" align="center">
  <tr>
    ...
    <div id="StatTitle">Boss Fight Stats</div> <div id="StatTitleV">Value</div>
    <div id="StatName">Boss Kills: </div> <div id="StatValue"><?php echo number_format($userp['boss_kills']) ?></div> 	
    </td>
	...
	if (mysql_num_rows($select_guns) > 0) {
		echo '<img src="images/'.$gun['image'].'.png" width="90" height="60" style="margin: 5px;" />';
		}
	}
	?>
	</div>
	...
	if (mysql_num_rows($select_guns) > 0) {
		echo '<img src="images/'.$prop['image'].'.png" width="90" height="60" style="margin: 5px;" />';
		}
	}
	?>
	</div>
