...
<div align="center "id="SubPage">Top Players: New York</div>
...
<?php
$number = 1;
$top_players = mysql_query("SELECT * FROM users WHERE location='New York' ORDER BY income DESC LIMIT 20");
...
<?php
$number = 1;
$top_players = mysql_query("SELECT * FROM users WHERE location='New York' ORDER BY e_income DESC LIMIT 20");
while($top_stats = mysql_fetch_array($top_players)) {
echo
'<div id="TPName" onClick="ViewUser('.$top_stats['id'].')">'.$number++.'. '.substr($top_stats['username'],0,10).'..</div>
...
<?php
$number = 1;
$top_players = mysql_query("SELECT * FROM users WHERE location='New York' ORDER BY level DESC LIMIT 20");
while($top_stats = mysql_fetch_array($top_players)) {
echo
'<div id="TPName" onClick="ViewUser('.$top_stats['id'].')">'.$number++.'. '.substr($top_stats['username'],0,10).'..</div>
...
<?php
$number = 1;
$top_players = mysql_query("SELECT * FROM users WHERE location='New York' ORDER BY missions DESC LIMIT 20");
while($top_stats = mysql_fetch_array($top_players)) {
echo
'<div id="TPName" onClick="ViewUser('.$top_stats['id'].')">'.$number++.'. '.substr($top_stats['username'],0,10).'..</div>
...
<?php
$number = 1;
$top_players = mysql_query("SELECT * FROM users WHERE location='New York' ORDER BY wins DESC LIMIT 20");
while($top_stats = mysql_fetch_array($top_players)) {
echo
'<div id="TPName" onClick="ViewUser('.$top_stats['id'].')">'.$number++.'. '.substr($top_stats['username'],0,10).'..</div>
...
<?php
$number = 1;
$top_players = mysql_query("SELECT * FROM users WHERE location='New York' ORDER BY kills DESC LIMIT 20");
while($top_stats = mysql_fetch_array($top_players)) {
echo
'<div id="TPName" onClick="ViewUser('.$top_stats['id'].')">'.$number++.'. '.substr($top_stats['username'],0,10).'..</div>
...
<?php
$number = 1;
$top_players = mysql_query("SELECT * FROM users WHERE location='New York' ORDER BY loses DESC LIMIT 20");
while($top_stats = mysql_fetch_array($top_players)) {
echo
'<div id="TPName" onClick="ViewUser('.$top_stats['id'].')">'.$number++.'. '.substr($top_stats['username'],0,10).'..</div>
...
<?php
$number = 1;
$top_players = mysql_query("SELECT * FROM users WHERE location='New York' ORDER BY bounties DESC LIMIT 20");
while($top_stats = mysql_fetch_array($top_players)) {
echo
'<div id="TPName" onClick="ViewUser('.$top_stats['id'].')">'.$number++.'. '.substr($top_stats['username'],0,10).'..</div>
