...
<body>
<?php
$select_weapons = mysql_query("SELECT * FROM all_equipment WHERE level<=".$level." AND type='inventory' ORDER BY id");
...
<table width="600" id="WeaponBlock">
  ...
  <tr>
    ...
    <div id="WeaponStat">Cost: '.number_format($weapon['cost']).' Boss Points</div>
    <div id="WeaponStat">Attack: '.$weapon['attack'].'</div>
    <div id="WeaponStat">Defense: '.$weapon['defense'].'</div>
	<div id="WeaponStat" style="color: #0FF; font-style: italic;">'.$weapon['desc'].'</div>
    </td>
    <td width="150">
